...
School Project robotic cart: https://github.com/vamichrom
...
def generate_launch_description():
    ...
    package_name_gazebo = 'robo_cart_gazebo'
    package_name_description = 'robo_cart_description'
    package_name_bringup = 'robo_cart_bringup'

    default_robot_name = 'robo_cart'
    gazebo_models_path = 'models'
    default_world_file = 'empty.world'
    gazebo_worlds_path = 'worlds'
    ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
    rviz_config_filename = 'robo_cart_gazebo_sim.rviz'
