#!/bin/bash
# Single script to launch School Project robo cart with Gazebo, Nav2 and ROS 2 Controllers
...
ros2 launch robo_cart_bringup robo_cart_navigation_launch.py \
    ...
    yaw:=0.0 \
    "$SLAM_ARG" \
    #map:=/<full path to file>/cafe_world_map.yaml &
