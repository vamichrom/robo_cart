...
def generate_launch_description():
    ...
    params_file_dec = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(get_package_share_directory('obj_tracker'),'config','obj_tracker_params_example.yaml'),
        description='Full path to params file for all obj_tracker nodes.')
