...
#ifndef ROS2_CONTROL_ARDUINO_HW__VISIBILITY_CONTROL_H_
#define ROS2_CONTROL_ARDUINO_HW__VISIBILITY_CONTROL_H_
...
#endif  // ROS2_CONTROL_ARDUINO_HW__VISIBILITY_CONTROL_H_
